...
function generateBox()
{
    ...
    let fullWidthIn = depthIn / 2 + widthIn * 2 + depthIn * 2 + 'in';
    let fullHeightIn = depthIn + heightIn + depthIn + offset * 0.8 / scale * 2 + 'in';
    ...
    draw
        ...
        .h(width)
        .M(depth / 2, depth / 2 + depth + height)
        .h(width)
        .M(depth / 2, depth / 2 + depth + height + depth)
        .h(width)
        .M(depth / 2, depth / 2 + depth)
        .v(height)
        .M(depth / 2 + width, depth / 2 + depth)
        .v(height)
        .M(depth / 2 + width, depth / 2 + depth)
        .h(depth)
        .M(depth / 2 + width, depth / 2 + depth + height)
        .h(depth)
        .M(depth / 2 + width + depth, depth / 2 + depth)
        .v(height)
        .M(depth / 2 + width + depth + width, depth / 2 + depth)
        .v(height)
        .M(depth / 2 + width + depth + width, depth / 2 + depth)
        .h(depth)
        .M(depth / 2 + width + depth + width, depth / 2 + depth + height)
        .h(depth);
}
